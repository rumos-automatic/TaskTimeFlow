...
## [0.9.31] - 2025-01-19 ⏱️ **タイムラインのタスク時間制限を撤廃**

### 🚀 機能改善
- **⏱️ タイムラインのタスク最大時間を24時間に拡張**
  - PC版タイムラインビューで、タスクカードの下部をドラッグして時間調整する際の制限を緩和
  - 最大時間：240分（4時間）→ 1440分（24時間）に変更
  - 最小時間：15分（維持）
  - 終日タスクや長時間プロジェクト作業に対応可能に

### 🔧 技術的改善
- **📝 コード修正**
  - `components/workspace/timeline.tsx:124` を1行のみ修正
  - 低リスクで効果的な改善を実現
  - 既存の15分単位スナップ機能は維持
