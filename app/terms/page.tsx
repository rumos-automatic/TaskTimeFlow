...
export const metadata: Metadata = {
  title: "利用規約 | TaskTimeFlow",
  description: "TaskTimeFlowの利用規約ページです。サービスのご利用にあたっての規約を説明しています。",
}
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6 text-sm md:text-base">
        <section>
          <p className="mb-4">
            この利用規約（以下、「本規約」といいます）は、TaskTimeFlow（以下、「当サービス」といいます）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます）には、本規約に従って、本サービスをご利用いただきます。
          </p>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li>本サービスにおいては、登録希望者が本規約に同意の上、当サービスの定める方法によって利用登録を申請し、当サービスがこの承認を登録希望者に通知することによって、利用登録が完了するものとします。</li>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li>本サービスには以下のプランがあります：
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>無料プラン：基本機能の利用が可能（広告表示あり）</li>
                <li>パーソナルプラン：月額$9.99（広告非表示、無制限タスク、Google完全同期）</li>
                <li>プロプラン：月額$19.99（AI機能、高度な分析機能を含む）</li>
                <li>チームプラン：月額$49.99（5ユーザー、チーム機能）</li>
                <li>エンタープライズプラン：カスタム価格</li>
              </ul>
            </li>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li>ユーザーは、本サービスを利用して投稿ないしアップロードした文章、画像、動画その他のデータについては、自らが投稿その他送信することについての適法な権利を有していること、および投稿データが第三者の権利を侵害していないことについて、当サービスに対し表明し、保証するものとします。</li>
            <li>ユーザーは、投稿データについて、自らが投稿その他送信することについての適法な権利を有していること、および投稿データが第三者の権利を侵害していないことについて、当サービスに対し表明し、保証するものとします。</li>
            <li>ユーザーは、投稿データについて、当サービスに対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、配布、派生著作物の作成、表示及び実行に関するライセンスを付与します。</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li>当サービスは、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、投稿データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限しまたはユーザーとしての登録を抹消することができるものとします。
              <ol className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li>前項各号のいずれかに該当した場合、ユーザーは、当然に当サービスに対する一切の債務について期限の利益を失い、その時点において負担する一切の債務を直ちに一括して弁済しなければなりません。</li>
        ...
        <section>
          ...
          <p>当サービスは、ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
        </section>
